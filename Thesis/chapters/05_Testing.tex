...
\begin{figure}[htpb]
  \centering
  \includegraphics[scale=0.77]{figures/plots/newPlots/base1test_perf}%B1_A}
...
\begin{figure}[htpb]
  \centering
  \includegraphics[scale=0.77]{figures/plots/newPlots/m1test_perf}%M1_perf}
...
\begin{figure}[htpb]
  \centering
  \includegraphics[scale=0.80]{figures/plots/newPlots/m2-test_perf}%M2-baADist}
